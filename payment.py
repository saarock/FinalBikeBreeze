...
from home import id_of_the_bike_which_is_uniqe
...
# label.place(x=0, y=0)
mainframe = Frame(root, height=2222,width=2205, background='orange1')
mainframe.pack()
...
def images():
 ...
 try:
    ...
    #  label_image_of_the_money.place(x=43,y=145)
 except Exception as e:
     print(e)
...
# wiitt = 304
# if(img_moneyyy):
#    sizea =img_moneyyy.resize((wiitt,heett))
#    imggg =ImageTk.PhotoImage(sizea)
#    label_image_of_the_money = Label(mainframe, image=imggg, bg='skyblue')
#    label_image_of_the_money.image = imggg
#    label_image_of_the_money.configure(image=imggg) 
#    label_image_of_the_money.place(x=43,y=145)
